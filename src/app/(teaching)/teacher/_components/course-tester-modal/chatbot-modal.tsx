...
export function ChatbotModal({
  ...
  return (
    <Dialog open={chatbotModalOpen} onOpenChange={setChatbotModalOpen}>
      <DialogContent className="!fixed !inset-0 !left-0 !top-0 !translate-x-0 !translate-y-0 !max-w-none !w-screen !h-[100dvh] !rounded-none !border-0 flex flex-col p-0 overflow-hidden [&>button]:hidden sm:!inset-auto sm:!left-1/2 sm:!top-1/2 sm:!-translate-x-1/2 sm:!-translate-y-1/2 sm:!max-w-3xl sm:!w-[95vw] sm:!h-[90vh] sm:!rounded-2xl sm:!border">
        <DialogHeader
