...
export function OrganizationSchema() {
  useEffect(() => {
    const jsonLd = {
      ...
      "description": "Plateforme éducative IA pour établissements scolaires français. Les professeurs déposent leurs cours, l'IA génère des questions et entraîne les élèves.",
      "sameAs": [],
      "contactPoint": {
        "@type": "ContactPoint",
        "telephone": "",
...
export function SoftwareApplicationSchema() {
  useEffect(() => {
    const jsonLd = {
      ...
      "description": "Plateforme éducative IA pour établissements scolaires. Génération automatique de questions à partir des cours, interface gamifiée type Kahoot/Duolingo.",
      "featureList": [
