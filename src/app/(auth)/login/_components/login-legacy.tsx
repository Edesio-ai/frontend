...
export default function LoginLegacy() {
  ...
  const lt = t.auth.login.legacy;

  const formSchema = z.object({
    email: z.string().email(lt.emailInvalid ?? t.supabaseErrors.invalidEmailFormat),
    password: z.string().min(1, lt.passwordRequired ?? t.supabaseErrors.validPasswordRequired),
  });
