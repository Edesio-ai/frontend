    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>{session.studentsCount} enrolled student(s)</DialogDescription>
        </DialogHeader>
        ...
        {loading ? (
          ...
          <div className="text-center py-8 text-muted-foreground">{t.establishment.sessionStudentModal.empty}</div>
        ) : (
          <Table>
            <TableHeader>
              <TableRow>
