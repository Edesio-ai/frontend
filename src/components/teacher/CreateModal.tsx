    ...
    <Dialog open={createModalOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-hidden flex flex-col p-0">
        <DialogHeader className="px-6 pt-6 pb-4 border-b flex-shrink-0">
          ...
          <DialogDescription>{t.teacher.createModal.subtitle}</DialogDescription>
        </DialogHeader>
            ...
            <form onSubmit={form.handleSubmit(onCreateSubmit)} className="space-y-6">
              ...
              <div className="border-t pt-6 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">{t.teacher.createModal.pdfHint}</p>
                  <div className="space-y-2">
                    <input
                      type="file"
              ...
              <div className="flex justify-end gap-2 pt-4 border-t">
                ...
                <Button
                  ...
                  data-testid="button-create-session-and-course"
                >
                  {isCreating ? (
                    <>
