            ...
            {isEditing ? (
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <Input value={editedDescription} onChange={(e) => setEditedDescription(e.target.value)} placeholder={t.dashboard.courseTester.fieldDescription} />
                    </div>
                    <div>
                        <label className="text-sm font-medium mb-1 block">{t.dashboard.courseTester.fieldTextContent}</label>
                        <Textarea value={editedContent} onChange={(e) => setEditedContent(e.target.value)} className="min-h-[120px]" placeholder={t.dashboard.courseTester.fieldContent} />
                    </div>
                </div>
            ) : (
                <Card className="p-4 space-y-3">
                    ...
                    {course.description && (
                        <div>
                            <span className="text-xs text-muted-foreground uppercase">{t.dashboard.courseTester.fieldDescription}</span>
