...
export function RegenerateQuestionModal({
    ...
    <Dialog open={regenerateDialogOpen} onOpenChange={setRegenerateDialogOpen}>
      <DialogContent className="sm:max-w-[480px]">
        ...
        <div className="space-y-3 py-4">
          ...
          <div className="flex items-center justify-between pt-3 mt-2 border-t">
            <span className="text-sm font-medium">
              {t.teacher.questionGenerator.totalToGenerate}{" "}
              <span className="text-muted-foreground font-normal">
                {t.teacher.questionGenerator.maxHint.replace("{max}", String(MAX_QUESTIONS))}
              </span>
            </span>
        ...
        <div className="flex justify-end gap-2">
          ...
          <Button onClick={executeGeneration} disabled={genTotalQuestions === 0} data-testid="button-confirm-generate">
